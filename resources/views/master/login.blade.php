...
@endif
            <form id="loginform" class="form-vertical" method="post" action="{{url('master/login')}}">  @csrf
				 <div class="control-group normal_text"> <h3><img src="{{asset('images/master/logo.png')}}" alt="Logo" /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="email"name ="email" value="{{ old('email') }}" placeholder="E-mail" required autocomplete="email" autofocus />
                        </div>
                    </div>
                </div>
                <div class="control-group">
